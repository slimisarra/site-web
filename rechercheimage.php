...
$image1C=new imageC();
$listeimage=$image1C->afficherImage();
...
<body class="animsition">
                        ...
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    ...
                                    <li>
											<a href="rechercheimage.php"><i class="fas fa-list"></i>Rechercher un élément du catalogue.</a>
									</li>
                                </ul>
                            </li>
                            <li class="has-sub">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Liste des coordonnées des images du catalogue.</h3>

                                <div class="table-responsive table-responsive-data2">
                                <form method="POST" action=""> 
     </br></br>Rechercher un mot : <input type="text" name="recherche">
     <button  class="btn btn-success" input type="SUBMIT" value="Recherche!">&nbsp;Recherche </button></br>
     </form>
     </html>
    ...
    $conn = mysqli_connect($db_server,$db_user_login, $db_user_pass, $db_name);
     ...
     // la requete mysql
     $q = $conn->query(
     "SELECT id_image, chemin_image FROM image
      WHERE id_image LIKE '%$recherche%'
      OR chemin_image LIKE '%$recherche%'
      LIMIT 10");
     ...
     while( $r = mysqli_fetch_array($q)){
        ...
        <thead>
        <tr>
        <th><?PHP echo $r['id_image']; ?></th>
        <th><?PHP echo $r['chemin_image']; ?></th></tr></thead></table>
        <?php
;
     }
?>
                                    <a href="ajouterimage.html">Ajouter une nouvelle image</br></br></a>
                                    <html>
