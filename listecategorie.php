                ...
                <div class="menu-sidebar__content js-scrollbar1">
                    <nav class="navbar-sidebar">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                                <i class="fas  fa-archive"></i>Gestion de produit et categorie</a>
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><form method="POST" action="modifiercategorie.php">
                                                    <input type="submit" name="modifier" value="modifier">
                                                    <input type="hidden" value="<?PHP echo $row['id_categorie']; ?>" name="id_categorie">
                                                    </form></th>
                                                    <th><form method="POST" action="supprimercategorie.php">
                                    ...
                                    <a href="ajoutercategorie.html">Ajouter une nouvelle categorie</a>
