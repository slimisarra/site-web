                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="title-5 m-b-35">Liste des promotions.</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
										...
										<?php
    include "../config.php";
         $periode=$_POST['promotion1'];
         
		
        $sql="select * from promotion where periode='$periode'";
		...
		try {
			...
			foreach($liste as $row){
				echo"<tr>";
				echo"<th>".$row['id_promo']."</th>";
				echo"<th>".$row['id_produit']."</th>";
				echo"<th>".$row['periode']."</th>";
				echo"<th>".$row['pourcentage']."</th>";
        ...
        ?>
                                    ...
                                    <a href="ajouterpromotion.html">Ajouter une nouvelle promotion</a> </br>
