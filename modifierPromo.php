                    ...
                    <nav class="navbar-sidebar">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="listeimage.html"><i class="fas fa-list"></i>Liste des éléments du catalogue.</a>
                                    </li>
                                    <li>
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="listenouveaute.html"><i class="fas fa-list"></i>Liste des nouveautés.</a>
                                    </li>
                                    <li>
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="listepromotion.php"><i class="fas fa-list"></i>Liste des promotions.</a>
                                    </li>
                                    <li>
...
include "../core/promotionC.php";
		...
		?>
                                ...
                                <h3 class="title-5 m-b-35">Modifier promotion</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                 <form method="POST">
                                    <table border="1" class="table table-data2">
                                        <thead>
                                            <tr>
                                                <th>Identifiant promotion</th>
                                                <th><input type="number" name="id_promo" value="<?PHP echo $id_promo ?>" disabled></th>
                                            </tr>
                                            <tr>
                                                <th>Identifiant produit</th>
                                                <th><input type="number" name="id_produit" value="<?PHP echo $id_produit ?>"></th>
                                            </tr>
                                            <tr>
                                                <th>Periode promotion</th>
                                                <th><input type="texte" name="periode" value="<?PHP echo $periode ?>"></th>
                                            </tr>
                                            <tr>
                                                <th>Pourcentage promotion</th>
                                                <th><input type="float" name="pourcentage" value="<?PHP echo $pourcentage ?>"></th>
                                            </tr>
                                            

                                            <tr>
                                                <th><input type="submit" name="modifier2" value=" MODIFIER "></th>
                                                <th><input type="hidden" name="id_promo" value="<?PHP echo $row['id_promo'];?>"></th>
                                            </tr>
                                        </thead>
                                        <?PHP
			}
